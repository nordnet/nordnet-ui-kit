    ...
    const example = (
      <div>
        <Row className="input-container">
          ...
          <Col xs={ 6 } sm={ 3 }>
            <Input type="text" id="input-text-4" label="Text input with success" placeholder="Enter text" value="Correct value" hasSuccess disabled />
          </Col>
        </Row>
        <Row className="input-container">
          <Col xs={ 6 } sm={ 3 }>
          ...
          <Col xs={ 6 } sm={ 3 }>
            <Input type="number" id="input-number-4" label="Number input with success" placeholder="Enter number" value={ 2 } hasSuccess disabled />
          </Col>
        </Row>
        <Row className="input-container">
          <Col xs={ 6 } sm={ 3 }>
          ...
          <Col xs={ 6 } sm={ 3 }>
            <Input type="select" id="input-select-4" label="Select input with success" placeholder="Pick an option" options = { selectOptions } value="3" hasSuccess disabled />
          </Col>
        </Row>
        <Row className="input-container">
          <Col xs={ 6 } sm={ 3 }>
          ...
          <Col xs={ 6 } sm={ 3 }>
            <Input type="password" id="input-password-4" label="Password input with success" placeholder="Enter password"value="Passw0rd!" hasSuccess disabled />
          </Col>
        </Row>
        <Row className="input-container">
          <Col xs={ 6 } sm={ 3 }>
          ...
          <Col xs={ 6 } sm={ 3 }>
            <Input type="date" id="input-date-4" label="Date input with success" placeholder="Enter date"value="2016-12-03" hasSuccess disabled />
          </Col>
        </Row>
        <Row className="input-container">
          <Col xs={ 6 } sm={ 3 }>
