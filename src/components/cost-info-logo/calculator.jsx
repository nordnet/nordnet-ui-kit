  ...
  return (
    <svg width={width} height={width} style={style} {...rest} viewBox={`0 0 36 36`}>
      <g stroke="none" strokeWidth={strokeWidth} fill="none" fillRule="evenodd">
        <g fillRule="nonzero">
          <path
            d="M17.1,14.9c0,1.1-0.9,2-2,2H2c-1.1,0-2-0.9-2-2V2c0-1.1,0.9-2,2-2h13.1c1.1,0,2,0.9,2,2V14.9z"
            fill={fill}
          />
          <path
          ...
          />
          <path
            d="M17.1,33.6c0,1.1-0.9,2-2,2H2c-1.1,0-2-0.9-2-2V20.6c0-1.1,0.9-2,2-2h13.1c1.1,0,2,0.9,2,2 V33.6z"
            fill={fill}
          />
          <path
