...
function SharevilleLogo({ onlyIcon, height }) {
  const width = onlyIcon ? height : height * 4.89;
  ...
  return (
    <svg viewBox="0 0 232.01 257.26" width={width} height={height}>
      <defs>
        <style
          dangerouslySetInnerHTML={{
            __html: '.sharevilleLogoWTClass-1{fill:#008c44;}.sharevilleLogoWTClass-2{fill:url(#linear-gradient);}.sharevilleLogoWTClass-3{fill:url(#linear-gradient-2);}.sharevilleLogoWTClass-4{fill:url(#linear-gradient-3);}',
          }}
        />
        <linearGradient
          id="linear-gradient"
      ...
      <path
        className="sharevilleLogoWTClass-1"
      ...
      />
      <path
        className="sharevilleLogoWTClass-2"
      ...
      />
      <path
        className="sharevilleLogoWTClass-3"
      ...
      />
      <path
        className="sharevilleLogoWTClass-4"
