    ...
    <svg aria-hidden="true" focusable="false" {...rest}>
      <g id="icons" stroke="none" strokeWidth={strokeWidth} fill="none" fillRule="evenodd">
        <g id="expand" fillRule="nonzero" fill={fill}>
          ...
          />
          <path
            d="M15.6,0 L11.6,0 C11.3792,0 11.2,0.1792 11.2,0.4 C11.2,0.6208 11.3792,0.8 11.6,0.8 L14.6344,0.8 L9.7176,5.7168
          ...
          />
          <path
            d="M6.2832,9.7176 C6.1272,9.5616 5.8736,9.5616 5.7176,9.7176 L0.8008,14.6344 L0.8008,11.6 C0.8008,11.3792
          ...
          />
          <path
            d="M15.6,11.2 C15.3792,11.2 15.2,11.3792 15.2,11.6 L15.2,14.6344 L10.2824,9.7176 C10.1264,9.5616 9.8728,9.5616
