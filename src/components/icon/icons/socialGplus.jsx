  ...
  return (
    <svg {...rest}>
      <g id="Page-1" stroke="none" strokeWidth={strokeWidth} fill="none" fillRule="evenodd">
        <g id="Artboard-1" transform="translate(-1197.000000, -282.000000)" stroke={stroke} strokeWidth={strokeWidth}>
          <g id="social-gplus" transform="translate(1197.000000, 282.000000)">
